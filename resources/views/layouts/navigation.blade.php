<nav x-data="{ open: false }" class="bg-gray-800 border-b border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('visualizer.index')" :active="request()->routeIs('visualizer.index')" class="text-gray-300 hover:text-white">
                        {{ __('Visualizer') }}
                    </x-nav-link>
                    <x-nav-link :href="route('screenshots.index')" :active="request()->routeIs('screenshots.index')" class="text-gray-300 hover:text-white">
                        {{ __('Screenshots') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="text-gray-300 hover:bg-gray-700">
                {{ __('Dashboard') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('visualizer.index')" :active="request()->routeIs('visualizer.index')" class="text-gray-300 hover:bg-gray-700">
                {{ __('Visualizer') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('screenshots.index')" :active="request()->routeIs('screenshots.index')" class="text-gray-300 hover:bg-gray-700">
                {{ __('Screenshots') }}
            </x-responsive-nav-link>
            @if(auth()->user()->hasRole('admin'))
                <x-responsive-nav-link :href="route('admin.users.index')" :active="request()->routeIs('admin.users.*')" class="text-gray-300 hover:bg-gray-700">
                    {{ __('Users') }}
                </x-responsive-nav-link>
            @endif
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-700">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('profile.edit')" class="text-gray-300 hover:bg-gray-700">
                    {{ __('Profile') }}
                </x-responsive-nav-link>
